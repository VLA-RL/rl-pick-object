...
from adaptive_buffer_TD3Agent import TD3Agent
import os
import glob
import re
...
weights_dir = "./adaptive_td3_weights"
...
for episode in range(start_episode, num_episodes):
    ...
    if (episode + 1) % 100 == 0:
        agent.save(f"./adaptive_td3_weights/td3_pick_described_object_{episode + 1}")

# Save final model
agent.save("./adaptive_td3_weights/td3_pick_described_object_final")
